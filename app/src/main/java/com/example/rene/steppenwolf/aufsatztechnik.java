...
public class aufsatztechnik extends AppCompatActivity {
    ...
    private void prepare(){
        headlines = new ArrayList<>(Arrays.asList(getResources().getStringArray(R.array.aufsatztechnik_headlines)));
        ArrayList<String> texts  = new ArrayList<>(Arrays.asList(getResources().getStringArray(R.array.aufsatztechnik_texts)));
    ...
    private void setToolbar(){
        ...
        toolbar.setTitle("Aufsatztechnik");
