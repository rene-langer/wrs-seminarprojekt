...
public class struktur extends AppCompatActivity {
    ...
    private void prepareListData(){
        ...
        headlines = new ArrayList<>(Arrays.asList(getResources().getStringArray(R.array.struktur_headlines)));
        childs = new HashMap<>();
    ...
    private void prepare(){
        headlines = new ArrayList<>(Arrays.asList(getResources().getStringArray(R.array.struktur_headlines)));
        ArrayList<String> texts  = new ArrayList<>(Arrays.asList(getResources().getStringArray(R.array.struktur_texts)));
    ...
    private void setToolbar(){
        ...
        toolbar.setTitle("Struktur und Aufbau");
