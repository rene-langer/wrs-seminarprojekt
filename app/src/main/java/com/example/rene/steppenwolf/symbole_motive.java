...
/**
 * Created by rene on 11.01.18.
 */

public class symbole_motive extends AppCompatActivity {
    ...
    private void prepare() {
        headlines = new ArrayList<>(Arrays.asList(getResources().getStringArray(R.array.symbole_motive_headlines)));
        ArrayList<String> texts = new ArrayList<>(Arrays.asList(getResources().getStringArray(R.array.symbole_motive_texts)));
    ...
    private void setToolbar() {
        ...
        toolbar.setTitle("Symbole und Motive");
