...
public class quiz extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragen = getResources().getStringArray(R.array.hermine_quiz_fragen);
        richtigeAntworten = getResources().getStringArray(R.array.correct_answers);

        String[] temp = getResources().getStringArray(R.array.antwort_1);
        antworten.add(temp);
        temp = getResources().getStringArray(R.array.antwort_2);
        antworten.add(temp);
        temp = getResources().getStringArray(R.array.antwort_3);
        antworten.add(temp);
        temp = getResources().getStringArray(R.array.antwort_4);
        antworten.add(temp);
        temp = getResources().getStringArray(R.array.antwort_5);
        antworten.add(temp);
        temp = getResources().getStringArray(R.array.antwort_6);
        antworten.add(temp);
        temp = getResources().getStringArray(R.array.antwort_7);
        antworten.add(temp);
        temp = getResources().getStringArray(R.array.antwort_8);
        antworten.add(temp);
