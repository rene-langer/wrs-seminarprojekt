...
public class autor extends AppCompatActivity {
    ...
    private void prepare() {
        headlines = new ArrayList<>(Arrays.asList(getResources().getStringArray(R.array.author_headlines)));
        ArrayList<String> texts = new ArrayList<>(Arrays.asList(getResources().getStringArray(R.array.author_texts)));
